...
<body>
   ...
   <p><?php echo date("Y年n月j日"); ?></p>
	...
	<p1>継続型XSSとは攻撃スクリプトがWebアプリケーション内部に保存されて実行されるXSSです。<br></p1>
		...
		<p1>HTTPメソッド処理をしたところで対策がされていないため脆弱性があります。<br></p1>
		<img src="./images/php-param-vuln.png" alt="対策が施されていないコード" title="photo"><br>
		<div style="padding: 10px;"></div>
		<p1>エスケープ処理が必要なのでHTTPメソッド処理を見つけたら以下のようにする。</p>
		<img src="./images/php-escape-stored.png" alt="対策済みコード" tilte="photo"><br>
		...
		<br>
		<div style="padding: 15px;"></div>
		<h3><a href="http://localhost:8080/secure/xss2_req.php">実行画面へ移動</a></h3>
